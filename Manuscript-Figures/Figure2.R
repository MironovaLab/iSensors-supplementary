...
ggsave("Manuscript-Figures/out/Fig2A_AuxinTreated_DimPlot_integrated.pdf", last_plot(), width = 6, height = 4.0, dpi = 300)
...
p
ggsave("Manuscript-Figures/out/Fig2A_AuxinTreated_ARF_FeaturePlot_integrated.pdf", last_plot(), width = 3, height = 3.0, dpi = 300)
...
p
ggsave("Manuscript-Figures/out/Fig2B_AuxinTreated_ARF_FeaturePlot_split.pdf", last_plot(), width = 4, height = 4.0, dpi = 300)

#Figure D-E ----
#the script is from see 02-iSensors-AuxinRoot-global-evaluation.R
...
res_global <- pb_long %>%
  ...
  mutate(
    ...
    class = case_when(
      p_adj < 0.05 & effect > 0.01 ~ "Up",
      p_adj < 0.05 & effect < -0.01 ~ "Down",
      TRUE                     ~ "n.s."
    )
  ) %>%
...
ggsave(
  "Manuscript-Figures/out/Fig2DE-iSensors_replica_heatmap_plus_forest.pdf",
  plot = p_final,
  width = 10,
  height = 8,
  dpi = 300,
...
p_final2
ggsave(
  "Manuscript-Figures/out/Fig2CDE_iSensors_replica_heatmap_plus_forest.pdf",
  plot = p_final2,
  width = 14,
  height = 8,
  dpi = 300,
